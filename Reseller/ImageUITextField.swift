...
//  Hyprviscomatic
//
//  Created by Lady Barretto on 27/08/2017.
...
class ImageUITextField: UITextField {
    ...
    let fieldPadding = UIEdgeInsets(top: 0, left: 30, bottom: 0, right: 5);
